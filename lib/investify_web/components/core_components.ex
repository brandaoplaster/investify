defmodule InvestifyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(InvestifyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(InvestifyWeb.Gettext, "errors", msg, opts)
    end
  end
